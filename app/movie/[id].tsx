    ...
    return (
        <View className='bg-primary flex-1'>
            <ScrollView contentContainerStyle={{
                ...
                <View className='felx-col items-start justify-center mt-5 px-5 '>
                    ...
                    <View className='flex-row items-center bg-dark-100  px-2 py-1 rounded -md gap-x-1 mt-2'>
                        ...
                        <Text className='text-bold text-sm text-white'>{Math.round(movie?.vote_average ?? 0)}/10</Text>
                        <Text className='text-light-200 text-sm'>
                    ...
                    <View className='flex flex-row justify-between w-1/2 '>
                        ...
                        <MovieInfo
                            label="Revenue"
                            value={
                                movie?.revenue?`$${Math.round(movie.revenue / 1_000_000)} M`: 'N/A'}/>
                    </View>
